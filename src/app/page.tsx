  ...
  return (
    <header className="sticky top-0 z-20 border-b border-line bg-paper/85 backdrop-blur">
      <div className="mx-auto flex max-w-5xl items-center justify-between px-5 py-3">
        <span className="text-sm font-bold tracking-wide text-brand">VOCA BRAIN MAP</span>
...
function Hero() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute inset-x-0 -top-32 h-96 bg-[radial-gradient(ellipse_at_top,var(--color-brand-soft),transparent_65%)]"
      />
      <div className="relative mx-auto grid max-w-5xl gap-10 px-5 pb-16 pt-14 sm:pt-20 lg:grid-cols-[1.05fr_1fr] lg:items-center lg:gap-12">
        <div>
          <p className="text-sm font-semibold tracking-wide text-brand">영어 어휘 학습</p>
          <h1 className="mt-3 text-4xl font-bold leading-[1.2] tracking-tight break-keep sm:text-5xl">
            암기는 반복하고,
            <br />
            이해가 필요한 단어는
            <br className="sm:hidden lg:block" /> 연결한다.
          </h1>
          <p className="mt-5 max-w-xl text-base leading-relaxed text-muted break-keep sm:text-lg">
        ...
        <div className="mt-4 lg:mt-0">
          <MapIllustration />
          <p className="mt-3 text-center text-xs text-muted break-keep">
  ...
  return (
    <section className="border-y border-line bg-surface">
      <div className="mx-auto max-w-5xl px-5 py-14">
        <h2 className="max-w-xl text-2xl font-bold leading-snug tracking-tight break-keep sm:text-3xl">
          단어장은 다 외웠는데,
          <br />왜 문장에서는 안 보일까요?
        </h2>
        <div className="mt-6 grid gap-4 sm:grid-cols-3">
          {[
            ...
            <div key={item.q} className="card p-5">
              ...
              <p className="mt-2 text-sm leading-relaxed text-muted break-keep">{item.a}</p>
            </div>
          ))}
        </div>
        <p className="mt-6 max-w-xl text-base leading-relaxed break-keep">
          ...
          <span className="text-muted"> 이 둘을 구분하는 것이 이 서비스가 하는 일입니다.</span>
        </p>
      </div>
    </section>
  )
...
function Loop() {
  return (
    <section className="mx-auto max-w-5xl px-5 py-16">
      <h2 className="text-2xl font-bold tracking-tight break-keep sm:text-3xl">
        학습은 이렇게 돕니다
      </h2>
        ...
        {LOOP.map((step, i) => (
          <li key={step.title} className="flex gap-4">
            ...
            <div className={`pb-7 ${i === LOOP.length - 1 ? 'pb-0' : ''}`}>
              ...
              <p className="mt-1 text-sm leading-relaxed text-muted break-keep">{step.body}</p>
            </div>
          </li>
        ))}
      </ol>
  ...
  return (
    <section className="border-y border-line bg-surface">
      <div className="mx-auto max-w-5xl px-5 py-16">
        ...
        <p className="mt-3 max-w-2xl leading-relaxed text-muted break-keep">
        ...
        <ul className="mt-8 grid gap-4 sm:grid-cols-2">
          {NODE_TYPES.map((node) => (
            <li key={node} className="card p-5">
              <p className="font-semibold break-keep">{NODE_LABEL[node]}</p>
              <p className="mt-1.5 text-sm leading-relaxed text-muted break-keep">
                {NODE_BLURB[node]}
              </p>
            </li>
          ))}
        ...
        <div className="mt-8 rounded-xl border border-line bg-paper px-5 py-4">
          <p className="text-sm font-semibold break-keep">색은 꾸밈이 아니라 상태입니다</p>
...
function Sample() {
  return (
    <section className="mx-auto max-w-5xl px-5 py-16">
      ...
      <p className="mt-2 text-muted break-keep">단어 maintain의 Brain Map 일부입니다.</p>

      <div className="mt-7 grid gap-4 sm:grid-cols-2">
        <div className="card border-brand/30 bg-brand-soft/40 p-5">
        ...
        <div className="card p-5">
          <p className="text-xs font-semibold tracking-wide text-brand">SIMILAR WORDS</p>
          ...
          <p className="mt-3 rounded-lg bg-line/30 px-3 py-2 text-sm break-keep">
      ...
      <div className="mx-auto grid max-w-5xl gap-6 px-5 py-16 sm:grid-cols-2">
        {[
          ...
          <div key={card.role} className="card p-6">
            ...
            <p className="mt-3 text-lg font-bold break-keep">{card.title}</p>
...
function FinalCta() {
  return (
    <section className="mx-auto max-w-5xl px-5 py-20 text-center">
      ...
      <p className="mx-auto mt-3 max-w-md text-muted break-keep">
