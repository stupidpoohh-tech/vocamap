...
import { droppedParams } from '@/lib/db/connection-string'
...
const HINTS: Record<string, string> = {
  ...
  CONNECT_TIMEOUT: '연결이 시간 초과되었습니다. 주소가 올바른지 확인해 주세요.',
...
export async function GET() {
  ...
  const stripped = droppedParams(process.env.DATABASE_URL ?? '')
